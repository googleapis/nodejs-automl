...
describe('v1beta1.AutoMlClient', () => {
    ...
    describe('createDataset', () => {
        it('invokes createDataset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.CreateDatasetRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.Dataset());
        ...
        it('invokes createDataset with error', async () => {
            ...
            await assert.rejects(async () => { await client.createDataset(request); }, expectedError);
            assert((client.innerApiCalls.createDataset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getDataset', () => {
        it('invokes getDataset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.GetDatasetRequest());
            request.name = '';
        ...
        it('invokes getDataset with error', async () => {
            ...
            await assert.rejects(async () => { await client.getDataset(request); }, expectedError);
            assert((client.innerApiCalls.getDataset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateDataset', () => {
        it('invokes updateDataset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.UpdateDatasetRequest());
            request.dataset = {};
        ...
        it('invokes updateDataset with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateDataset(request); }, expectedError);
            assert((client.innerApiCalls.updateDataset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getAnnotationSpec', () => {
        it('invokes getAnnotationSpec without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.GetAnnotationSpecRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.AnnotationSpec());
        ...
        it('invokes getAnnotationSpec with error', async () => {
            ...
            await assert.rejects(async () => { await client.getAnnotationSpec(request); }, expectedError);
            assert((client.innerApiCalls.getAnnotationSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getTableSpec', () => {
        it('invokes getTableSpec without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.GetTableSpecRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.TableSpec());
            client.innerApiCalls.getTableSpec = stubSimpleCall(expectedResponse);
            const [response] = await client.getTableSpec(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getTableSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getTableSpec with error', async () => {
            ...
            await assert.rejects(async () => { await client.getTableSpec(request); }, expectedError);
            assert((client.innerApiCalls.getTableSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateTableSpec', () => {
        it('invokes updateTableSpec without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateTableSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateTableSpec with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateTableSpec(request); }, expectedError);
            assert((client.innerApiCalls.updateTableSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getColumnSpec', () => {
        it('invokes getColumnSpec without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.GetColumnSpecRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ColumnSpec());
            client.innerApiCalls.getColumnSpec = stubSimpleCall(expectedResponse);
            const [response] = await client.getColumnSpec(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getColumnSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getColumnSpec with error', async () => {
            ...
            await assert.rejects(async () => { await client.getColumnSpec(request); }, expectedError);
            assert((client.innerApiCalls.getColumnSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateColumnSpec', () => {
        it('invokes updateColumnSpec without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.UpdateColumnSpecRequest());
            request.columnSpec = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateColumnSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateColumnSpec with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateColumnSpec(request); }, expectedError);
            assert((client.innerApiCalls.updateColumnSpec as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.GetModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.Model());
        ...
        it('invokes getModel with error', async () => {
            ...
            await assert.rejects(async () => { await client.getModel(request); }, expectedError);
            assert((client.innerApiCalls.getModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getModelEvaluation', () => {
        it('invokes getModelEvaluation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.GetModelEvaluationRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ModelEvaluation());
        ...
        it('invokes getModelEvaluation with error', async () => {
            ...
            await assert.rejects(async () => { await client.getModelEvaluation(request); }, expectedError);
            assert((client.innerApiCalls.getModelEvaluation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteDataset', () => {
        it('invokes deleteDataset without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.DeleteDatasetRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteDataset with call error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteDataset(request); }, expectedError);
            assert((client.innerApiCalls.deleteDataset as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('importData', () => {
        it('invokes importData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ImportDataRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes importData with call error', async () => {
            ...
            await assert.rejects(async () => { await client.importData(request); }, expectedError);
            assert((client.innerApiCalls.importData as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportData', () => {
        ...
        it('invokes exportData with call error', async () => {
            ...
            await assert.rejects(async () => { await client.exportData(request); }, expectedError);
            assert((client.innerApiCalls.exportData as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.CreateModelRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes createModel with call error', async () => {
            ...
            await assert.rejects(async () => { await client.createModel(request); }, expectedError);
            assert((client.innerApiCalls.createModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.DeleteModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteModel with call error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteModel(request); }, expectedError);
            assert((client.innerApiCalls.deleteModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deployModel', () => {
        it('invokes deployModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.DeployModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deployModel with call error', async () => {
            ...
            await assert.rejects(async () => { await client.deployModel(request); }, expectedError);
            assert((client.innerApiCalls.deployModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('undeployModel', () => {
        it('invokes undeployModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.UndeployModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes undeployModel with call error', async () => {
            ...
            await assert.rejects(async () => { await client.undeployModel(request); }, expectedError);
            assert((client.innerApiCalls.undeployModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportModel', () => {
        ...
        it('invokes exportModel with call error', async () => {
            ...
            await assert.rejects(async () => { await client.exportModel(request); }, expectedError);
            assert((client.innerApiCalls.exportModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportEvaluatedExamples', () => {
        it('invokes exportEvaluatedExamples without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportEvaluatedExamples as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes exportEvaluatedExamples with call error', async () => {
            ...
            await assert.rejects(async () => { await client.exportEvaluatedExamples(request); }, expectedError);
            assert((client.innerApiCalls.exportEvaluatedExamples as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listDatasets', () => {
        it('invokes listDatasets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ListDatasetsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listDatasets with error', async () => {
            ...
            await assert.rejects(async () => { await client.listDatasets(request); }, expectedError);
            assert((client.innerApiCalls.listDatasets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTableSpecs', () => {
        it('invokes listTableSpecs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ListTableSpecsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listTableSpecs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listTableSpecs with error', async () => {
            ...
            await assert.rejects(async () => { await client.listTableSpecs(request); }, expectedError);
            assert((client.innerApiCalls.listTableSpecs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listColumnSpecs', () => {
        it('invokes listColumnSpecs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ListColumnSpecsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listColumnSpecs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listColumnSpecs with error', async () => {
            ...
            await assert.rejects(async () => { await client.listColumnSpecs(request); }, expectedError);
            assert((client.innerApiCalls.listColumnSpecs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ListModelsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listModels with error', async () => {
            ...
            await assert.rejects(async () => { await client.listModels(request); }, expectedError);
            assert((client.innerApiCalls.listModels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listModelEvaluations', () => {
        it('invokes listModelEvaluations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.ListModelEvaluationsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listModelEvaluations with error', async () => {
            ...
            await assert.rejects(async () => { await client.listModelEvaluations(request); }, expectedError);
            assert((client.innerApiCalls.listModelEvaluations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
