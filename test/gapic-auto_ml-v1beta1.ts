...
describe('v1beta1.AutoMlClient', () => {
    ...
    describe('exportEvaluatedExamples', () => {
        it('invokes exportEvaluatedExamples without error', done => {
            ...
            client.exportEvaluatedExamples(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('listTableSpecs', () => {
        it('invokes listTableSpecs without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listTableSpecs = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listTableSpecsStream', () => {
        it('invokes listTableSpecsStream without error', done => {
            ...
            const stream = client.listTableSpecsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listColumnSpecs', () => {
        it('invokes listColumnSpecs without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listColumnSpecs = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listColumnSpecsStream', () => {
        it('invokes listColumnSpecsStream without error', done => {
            ...
            const stream = client.listColumnSpecsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
