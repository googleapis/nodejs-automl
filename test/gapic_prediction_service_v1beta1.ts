...
describe('v1beta1.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.PredictRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1beta1.PredictResponse());
        ...
        it('invokes predict with error', async () => {
            ...
            await assert.rejects(async () => { await client.predict(request); }, expectedError);
            assert((client.innerApiCalls.predict as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('batchPredict', () => {
        it('invokes batchPredict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.automl.v1beta1.BatchPredictRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes batchPredict with call error', async () => {
            ...
            await assert.rejects(async () => { await client.batchPredict(request); }, expectedError);
            assert((client.innerApiCalls.batchPredict as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
