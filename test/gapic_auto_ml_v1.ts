...
describe('v1.AutoMlClient', () => {
    ...
    describe('getDataset', () => {
        it('invokes getDataset without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1.Dataset());
    ...
    describe('getAnnotationSpec', () => {
        it('invokes getAnnotationSpec without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1.AnnotationSpec());
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1.Model());
    ...
    describe('updateModel', () => {
        ...
        it('invokes updateModel with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateModel(request); }, expectedError);
            assert((client.innerApiCalls.updateModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getModelEvaluation', () => {
        it('invokes getModelEvaluation without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.automl.v1.ModelEvaluation());
