...
describe('v1beta1.AutoMlClient', () => {
    ...
    describe('getTableSpec', () => {
        it('invokes getTableSpec without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTableSpecRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateTableSpec', () => {
        it('invokes updateTableSpec without error', async () => {
            ...
            request.tableSpec ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateTableSpecRequest', ['tableSpec', 'name']);
    ...
    describe('getColumnSpec', () => {
        it('invokes getColumnSpec without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetColumnSpecRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateColumnSpec', () => {
        it('invokes updateColumnSpec without error', async () => {
            ...
            request.columnSpec ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateColumnSpecRequest', ['columnSpec', 'name']);
    ...
    describe('deployModel', () => {
        it('invokes deployModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeployModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeployModel', () => {
        it('invokes undeployModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeployModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('exportEvaluatedExamples', () => {
        it('invokes exportEvaluatedExamples without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportEvaluatedExamplesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listTableSpecs', () => {
        it('invokes listTableSpecs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTableSpecsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listColumnSpecs', () => {
        it('invokes listColumnSpecs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListColumnSpecsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
