...
export class PredictionServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.predictionServiceStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.cloud.automl.v1.PredictionService') :
  ...
  predict(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.automl.v1.IPredictRequest|undefined, {}|undefined
      ]>;
  predict(
      request: protosTypes.google.cloud.automl.v1.IPredictRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  batchPredict(
      ...
      options?: gax.CallOptions):
      Promise<[
        LROperation<protosTypes.google.cloud.automl.v1.IBatchPredictResult, protosTypes.google.cloud.automl.v1.IOperationMetadata>,
